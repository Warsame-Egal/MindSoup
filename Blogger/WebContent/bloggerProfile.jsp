...
<body>
	...
	<div class="container-fluid">
		...
		<div id="top" class="jumbotron">
			...
			<br></br>
			<h3 class="text-center"><%=lang.getString("desc2")%></h3>
		</div>
	</div>
	<!-- /container -->
	...
	<div class="container-fluid">
		<div id="middle" class="jumbotron text-center">
			...
			//get the username that passed as a parameter this to jsp file.
		    String username = request.getParameter("userName") ;
			
			%>

			<h2><%=lang.getString("desc2") %></h2>
			...
			<%
				...
				String password = user.getPassword(); //TODO never display a user's password. this is for debuging porpuses 
